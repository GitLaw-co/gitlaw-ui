import{j as e}from"./jsx-runtime-DiklIkkE.js";import{I as t,c as a}from"./Icon-D7PltpT4.js";import"./index-DRjF_FHU.js";const ie=[{id:"draft",label:"Draft",icon:"draft"},{id:"review",label:"Review",icon:"review"},{id:"summarize",label:"Summarize",icon:"summarize"}],oe=({icon:r})=>{switch(r){case"draft":return e.jsx(t,{name:"file-plus",className:"size-4",color:a.iconPrimary});case"review":return e.jsx(t,{name:"file-search",className:"size-4",color:a.iconPrimary});case"summarize":return e.jsx(t,{name:"align-left",className:"size-4",color:a.iconPrimary});default:return null}},s=({status:r="active",size:J="l",placeholder:K="Draft a mutual NDA",value:x="",showQuickActions:X=!0,quickActions:Y=ie,onChange:v,onSubmit:Z,onQuickActionClick:f,onAttachmentClick:ee,onSettingsClick:te,onStopClick:ae,className:b=""})=>{const se=r==="working",re=r==="populated"||x.length>0,g=J==="l",w=g?"p-6":"p-4",ne=g?"gap-6":"gap-4",y=g?"rounded-xl":"rounded-lg";return se?e.jsx("div",{className:`
        ...
        w-full max-w-[624px]
        ${b}
      `,children:[e.jsxs("div",{className:"flex items-center gap-2.5 w-full",children:[e.jsx("input",{type:"text",value:x,onChange:n=>v==null?void 0:v(n.target.value),placeholder:K,className:`
          ...
          `}),re&&e.jsx("button",{type:"button",onClick:Z,className:`
            ...
            `,children:e.jsx(t,{name:"arrow-up",className:"size-6",color:a.iconNegative})})]}),e.jsxs("div",{className:"flex items-center justify-between w-full",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx("button",{type:"button",onClick:ee,className:"p-1 hover:bg-secondary rounded transition-colors",children:e.jsx(t,{name:"paperclip",className:"size-6",color:a.iconPrimary})}),e.jsx("button",{type:"button",onClick:te,className:"p-1 hover:bg-secondary rounded transition-colors",children:e.jsx(t,{name:"settings-2",className:"size-6",color:a.iconPrimary})})]}),X&&e.jsx("div",{className:"flex flex-wrap items-center justify-center gap-2",children:Y.map(n=>e.jsxs("button",{type:"button",onClick:()=>f==null?void 0:f(n),className:`
...
}`,...(T=(I=c.parameters)==null?void 0:I.docs)==null?void 0:T.source}}};var P,W,O;u.parameters={...u.parameters,docs:{...(P=u.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    status: 'populated',
    size: 'm',
    placeholder: 'Draft a mutual NDA',
...
}`,...(O=(W=u.parameters)==null?void 0:W.docs)==null?void 0:O.source}}};var V,$,M;d.parameters={...d.parameters,docs:{...(V=d.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    status: 'active',
    size: 'l',
...
}`,...(M=($=d.parameters)==null?void 0:$.docs)==null?void 0:M.source}}};var U,R,E;m.parameters={...m.parameters,docs:{...(U=m.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    status: 'active',
    size: 'l',
...
}`,...(E=(R=m.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};var _,L,B;p.parameters={...p.parameters,docs:{...(_=p.parameters)==null?void 0:_.docs,source:{originalSource:`{
...
}`,...(B=(L=p.parameters)==null?void 0:L.docs)==null?void 0:B.source}}};var F,G,H;h.parameters={...h.parameters,docs:{...(F=h.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-6">
      <div>
