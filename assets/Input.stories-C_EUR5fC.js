import{j as e}from"./jsx-runtime-DiklIkkE.js";import{r as L}from"./index-DRjF_FHU.js";import{I as z}from"./Icon-CCFihSvx.js";const ze={xl:{container:"gap-3 p-4 min-h-14",input:"text-base",label:"text-base"},l:{container:"gap-2 p-3 min-h-12",input:"text-base",label:"text-sm"},m:{container:"gap-2 p-2 min-h-9",input:"text-sm",label:"text-sm"},s:{container:"gap-1 px-2 py-1 min-h-7",input:"text-sm",label:"text-sm"},xs:{container:"gap-1 px-2 py-1 min-h-6",input:"text-xs",label:"text-xs"}},t=({size:a="m",status:ne,align:ie="fill",placeholder:ce="Placeholder text",value:r,onChange:l,showLabel:de=!1,label:pe="Label",showLeftIcon:ue=!1,showRightIcon:me=!1,leftIcon:he,rightIcon:xe,className:fe="",disabled:g=!1})=>{const[ge,y]=L.useState(""),[be,w]=L.useState(!1),b=r!==void 0?r:ge,ve=(ne||(be?"active":b?"populated":"empty"))==="active",ye=Le=>{const S=Le.target.value;r===void 0&&y(S),l==null||l(S)},we=()=>{r===void 0&&y(""),l==null||l("")},v=ze[a],Se=ie==="fill"?"w-full":"w-auto";return e.jsxs("div",{className:`flex flex-col gap-2 ${Se} ${fe}`,children:[de&&e.jsx("label",{className:`font-semibold text-text-primary ${v.label}`,children:pe}),e.jsxs("div",{className:`
...
}`,...(E=(I=s.parameters)==null?void 0:I.docs)==null?void 0:E.source}}};var T,N,R;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    size: 'm',
...
}`,...(R=(N=o.parameters)==null?void 0:N.docs)==null?void 0:R.source}}};var q,M,V;n.parameters={...n.parameters,docs:{...(q=n.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    size: 'm',
    placeholder: 'Search...',
    showLeftIcon: true,
...
}`,...(V=(M=n.parameters)==null?void 0:M.docs)==null?void 0:V.source}}};var A,D,$;i.parameters={...i.parameters,docs:{...(A=i.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    size: 'm',
    placeholder: 'Enter text...',
    value: 'Some content',
...
}`,...($=(D=i.parameters)==null?void 0:D.docs)==null?void 0:$.source}}};var P,W,C;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    size: 'm',
    placeholder: 'Enter text...',
    status: 'active',
...
}`,...(C=(W=c.parameters)==null?void 0:W.docs)==null?void 0:C.source}}};var X,_,k;d.parameters={...d.parameters,docs:{...(X=d.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    size: 'm',
...
}`,...(k=(_=d.parameters)==null?void 0:_.docs)==null?void 0:k.source}}};var F,B,O;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    size: 'xl',
