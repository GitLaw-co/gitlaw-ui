import{j as e}from"./jsx-runtime-DiklIkkE.js";import{r as N}from"./index-DRjF_FHU.js";import{I as Ae}from"./Icon-CCFihSvx.js";const qe={xl:{container:"p-4 min-h-24",text:"text-base",secondaryText:"text-xs"},l:{container:"p-3 min-h-20",text:"text-sm",secondaryText:"text-xxs"},m:{container:"p-2 min-h-20",text:"text-sm",secondaryText:"text-xxs"},s:{container:"p-2 min-h-16",text:"text-sm",secondaryText:"text-xxs"},xs:{container:"px-2 py-1 min-h-16",text:"text-xs",secondaryText:"text-xxs"}},$e={xl:"top-4 right-4",l:"top-3 right-3",m:"top-2 right-2",s:"top-2 right-2",xs:"top-1 right-2"},t=({size:y="m",status:ge,placeholder:f="Placeholder text",value:g,onChange:v,showStroke:ve=!0,showIcon:ze=!1,icon:ke,className:ye="",disabled:z=!1,rows:be=3})=>{const[Te,je]=N.useState(""),[Ne,b]=N.useState(!1),T=g!==void 0?g:Te,k=ge||(Ne?"active":T?"populated":"empty"),Ie=k==="active",Ee=k==="empty",Pe=Le=>{const j=Le.target.value;g===void 0&&je(j),v==null||v(j)},s=qe[y],Fe=$e[y];return e.jsxs("div",{className:`
      ...
      `,children:[ve&&e.jsx("div",{className:`
          ...
          `}),e.jsx("div",{className:"flex flex-col flex-1 min-h-px min-w-px relative",children:Ee?e.jsx("p",{className:`font-normal text-text-secondary leading-[1.4] ${s.text}`,children:f}):e.jsxs(e.Fragment,{children:[e.jsx("textarea",{value:T,onChange:Pe,onFocus:()=>b(!0),onBlur:()=>b(!1),placeholder:f,disabled:z,rows:be,className:`
...
}`,...(fe=(we=w.parameters)==null?void 0:we.docs)==null?void 0:fe.source}}};const We=["Default","Empty","Populated","Active","WithIcon","WithoutStroke","Disabled","ExtraLarge","Large","Medium","Small","ExtraSmall","AllSizes","AllStates","WithIconShowcase"];export{l as Active,x as AllSizes,S as AllStates,r as Default,c as Disabled,o as Empty,d as ExtraLarge,h as ExtraSmall,p as Large,m as Medium,a as Populated,u as Small,n as WithIcon,w as WithIconShowcase,i as WithoutStroke,We as __namedExportsOrder,Ve as default};
