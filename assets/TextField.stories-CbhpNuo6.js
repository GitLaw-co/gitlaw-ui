import{j as e}from"./jsx-runtime-DiklIkkE.js";import{r as N}from"./index-DRjF_FHU.js";import{I as Ae,c as qe}from"./colors-C61pH6SS.js";const $e={xl:{container:"p-4 min-h-24",text:"text-base",secondaryText:"text-xs"},l:{container:"p-3 min-h-20",text:"text-sm",secondaryText:"text-xxs"},m:{container:"p-2 min-h-20",text:"text-sm",secondaryText:"text-xxs"},s:{container:"p-2 min-h-16",text:"text-sm",secondaryText:"text-xxs"},xs:{container:"px-2 py-1 min-h-16",text:"text-xs",secondaryText:"text-xxs"}},Ce={xl:"top-4 right-4",l:"top-3 right-3",m:"top-2 right-2",s:"top-2 right-2",xs:"top-1 right-2"},t=({size:b="m",status:ge,placeholder:f="Placeholder text",value:g,onChange:v,showStroke:ve=!0,showIcon:ze=!1,icon:ke,className:be="",disabled:z=!1,rows:ye=3})=>{const[Te,je]=N.useState(""),[Ne,y]=N.useState(!1),T=g!==void 0?g:Te,k=ge||(Ne?"active":T?"populated":"empty"),Ie=k==="active",Pe=k==="empty",Ee=Le=>{const j=Le.target.value;g===void 0&&je(j),v==null||v(j)},s=$e[b],Fe=Ce[b];return e.jsxs("div",{className:`
      ...
      `,children:[ve&&e.jsx("div",{className:`
          ...
          `}),e.jsx("div",{className:"flex flex-col flex-1 min-h-px min-w-px relative",children:Pe?e.jsx("p",{className:`font-normal text-subtle leading-[1.4] ${s.text}`,children:f}):e.jsxs(e.Fragment,{children:[e.jsx("textarea",{value:T,onChange:Ee,onFocus:()=>y(!0),onBlur:()=>y(!1),placeholder:f,disabled:z,rows:ye,className:`
...
}`,...(ee=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var te,se,re;u.parameters={...u.parameters,docs:{...(te=u.parameters)==null?void 0:te.docs,source:{originalSource:`{
  args: {
    size: 'm',
    placeholder: 'Medium text field',
    showStroke: true
  }
}`,...(re=(se=u.parameters)==null?void 0:se.docs)==null?void 0:re.source}}};var oe,ae,le;m.parameters={...m.parameters,docs:{...(oe=m.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    size: 's',
    placeholder: 'Small text field',
    showStroke: true
  }
}`,...(le=(ae=m.parameters)==null?void 0:ae.docs)==null?void 0:le.source}}};var ne,ie,ce;h.parameters={...h.parameters,docs:{...(ne=h.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    size: 'xs',
    placeholder: 'Extra Small text field',
    showStroke: true
  }
}`,...(ce=(ie=h.parameters)==null?void 0:ie.docs)==null?void 0:ce.source}}};var de,pe,ue;x.parameters={...x.parameters,docs:{...(de=x.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(ue=(pe=x.parameters)==null?void 0:pe.docs)==null?void 0:ue.source}}};var me,he,xe;S.parameters={...S.parameters,docs:{...(me=S.parameters)==null?void 0:me.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-6">
      <div>
...
}`,...(fe=(we=w.parameters)==null?void 0:we.docs)==null?void 0:fe.source}}};const Re=["Default","Empty","Populated","Active","WithIcon","WithoutStroke","Disabled","ExtraLarge","Large","Medium","Small","ExtraSmall","AllSizes","AllStates","WithIconShowcase"];export{l as Active,x as AllSizes,S as AllStates,r as Default,c as Disabled,o as Empty,d as ExtraLarge,h as ExtraSmall,p as Large,u as Medium,a as Populated,m as Small,n as WithIcon,w as WithIconShowcase,i as WithoutStroke,Re as __namedExportsOrder,We as default};
