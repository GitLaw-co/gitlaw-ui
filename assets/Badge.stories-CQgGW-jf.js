import{j as e}from"./jsx-runtime-DiklIkkE.js";import{B as r}from"./Badge-BjU2t3Zv.js";import"./index-DRjF_FHU.js";const z={title:"Components/Badge",component:r,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{type:{control:"select",options:["primary","secondary","red","orange","green"],description:"The color type of the badge"},showNumber:{control:"boolean",description:"Show number in badge"},count:{control:"number",description:"The number to display"}}},s={args:{type:"primary",showNumber:!0,count:7}},a={args:{type:"secondary",showNumber:!0,count:5}},t={args:{type:"red",showNumber:!0,count:3}},o={args:{type:"orange",showNumber:!0,count:12}},n={args:{type:"green",showNumber:!0,count:1}},c={args:{type:"red",showNumber:!1}},p={render:()=>e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(r,{type:"primary",count:7}),e.jsx(r,{type:"secondary",count:5}),e.jsx(r,{type:"red",count:3}),e.jsx(r,{type:"orange",count:12}),e.jsx(r,{type:"green",count:1})]})},d={render:()=>e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(r,{type:"primary",showNumber:!1}),e.jsx(r,{type:"secondary",showNumber:!1}),e.jsx(r,{type:"red",showNumber:!1}),e.jsx(r,{type:"orange",showNumber:!1}),e.jsx(r,{type:"green",showNumber:!1})]})},u={render:()=>e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"relative inline-flex",children:[e.jsx("button",{className:"px-4 py-2 bg-secondary rounded text-text-button",children:"Notifications"}),e.jsx(r,{type:"red",count:3,className:"absolute -top-1 -right-1"})]}),e.jsxs("div",{className:"relative inline-flex",children:[e.jsx("button",{className:"px-4 py-2 bg-secondary rounded text-text-button",children:"Messages"}),e.jsx(r,{type:"primary",count:12,className:"absolute -top-1 -right-1"})]})]})};var m,l,i;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    type: 'primary',
    showNumber: true,
    count: 7
  }
}`,...(i=(l=s.parameters)==null?void 0:l.docs)==null?void 0:i.source}}};var y,g,b;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    type: 'secondary',
    showNumber: true,
    count: 5
  }
}`,...(b=(g=a.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};var x,N,h;t.parameters={...t.parameters,docs:{...(x=t.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    type: 'red',
    showNumber: true,
    count: 3
  }
}`,...(h=(N=t.parameters)==null?void 0:N.docs)==null?void 0:h.source}}};var f,w,j;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    type: 'orange',
    showNumber: true,
    count: 12
  }
}`,...(j=(w=o.parameters)==null?void 0:w.docs)==null?void 0:j.source}}};var v,B,S;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    type: 'green',
    showNumber: true,
    count: 1
  }
}`,...(S=(B=n.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var O,T,A;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    type: 'red',
    showNumber: false
  }
