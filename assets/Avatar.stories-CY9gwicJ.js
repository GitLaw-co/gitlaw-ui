import{j as e}from"./jsx-runtime-DiklIkkE.js";import{I as f}from"./Icon-CCFihSvx.js";import{c as y}from"./colors-CkkS3ZSj.js";import"./index-DRjF_FHU.js";const te={S:{container:"size-6",text:"text-xs",icon:"size-6"},M:{container:"size-8",text:"text-sm",icon:"size-6"},L:{container:"size-12",text:"text-xl",icon:"size-6"},XL:{container:"size-16",text:"text-2xl",icon:"size-6"}},s=({type:a="image",size:Q="M",src:z,initials:Y="AC",alt:Z="Avatar",showEdit:ee=!1,onEditClick:se,className:ae=""})=>{const g=te[Q],ie=a==="image"?"":"bg-primary";return e.jsxs("div",{className:`relative inline-block ${ae}`,children:[e.jsxs("div",{className:`
          ${g.container}
          ${ie}
          rounded overflow-hidden
          flex items-center justify-center
        `,children:[a==="image"&&z&&e.jsx("img",{src:z,alt:Z,className:"w-full h-full object-cover"}),a==="initials"&&e.jsx("span",{className:`font-black text-text-negative ${g.text}`,children:Y}),a==="icon"&&e.jsx(f,{name:"building",className:g.icon,color:y.iconNegative}),a==="empty"&&e.jsxs("div",{className:"flex flex-col items-center justify-center gap-1",children:[e.jsx(f,{name:"image-up",className:"size-4",color:y.iconNegative}),e.jsx("span",{className:"text-xxs text-text-negative",children:"Add"})]})]}),ee&&e.jsx("button",{type:"button",onClick:se,className:`
...
}`,...(P=(K=u.parameters)==null?void 0:K.docs)==null?void 0:P.source}}};const pe=["Image","Initials","Icon","Empty","WithEdit","SizeSmall","SizeMedium","SizeLarge","SizeExtraLarge","AllTypes","AllSizes"];export{u as AllSizes,d as AllTypes,n as Empty,r as Icon,i as Image,t as Initials,m as SizeExtraLarge,p as SizeLarge,l as SizeMedium,c as SizeSmall,o as WithEdit,pe as __namedExportsOrder,le as default};
