import{j as e}from"./jsx-runtime-DiklIkkE.js";import{r as t}from"./index-DRjF_FHU.js";import{E as F}from"./EditorHeader-Dtz6iZAi.js";import{c as X}from"./breakpoints-BVW42eJe.js";import{E as _}from"./EditorPaper-D3UKQN8I.js";import"./Button-CdwoKqKF.js";import"./colors-C61pH6SS.js";import"./Tooltip-BJTLr6Td.js";import"./Input-Pmm5UaGV.js";const $=X["@xs"],d=({isOpen:r=!0,onClose:c,initialWidth:l,minWidth:u=400,maxWidth:b,onWidthChange:i,headerProps:L={},children:q,className:H=""})=>{const s=t.useRef(null),[w,S]=t.useState(l),[o,N]=t.useState(!1),j=t.useRef(0),W=t.useRef(0),O=t.useRef(0),v=t.useCallback(()=>{var n;return b||((n=s.current)!=null&&n.parentElement?s.current.parentElement.clientWidth-4:1200)},[b]),z=t.useCallback(n=>{if(n.preventDefault(),n.stopPropagation(),s.current){const m=s.current.getBoundingClientRect().width;j.current=n.clientX,W.current=m}N(!0)},[]);return t.useEffect(()=>{if(!o)return;const n=p=>{p.preventDefault();const a=j.current-p.clientX,y=W.current+a,h=Math.max(u,Math.min(y,v()));O.current=h,S(h),i==null||i(h)},m=p=>{p.preventDefault();const a=v(),y=O.current;a-y<$&&(S(a),i==null||i(a)),N(!1)};return document.addEventListener("mousemove",n,{passive:!1}),document.addEventListener("mouseup",m),()=>{document.removeEventListener("mousemove",n),document.removeEventListener("mouseup",m)}},[o,u,v]),t.useEffect(()=>(o?(document.body.style.cursor="ew-resize",document.body.style.userSelect="none"):(document.body.style.cursor="",document.body.style.userSelect=""),()=>{document.body.style.cursor="",document.body.style.userSelect=""}),[o]),r?e.jsxs("div",{ref:s,className:`
...
}`,...(k=(P=x.parameters)==null?void 0:P.docs)==null?void 0:k.source}}};const te=["Default","WideWidth","NarrowWidth"];export{f as Default,x as NarrowWidth,g as WideWidth,te as __namedExportsOrder,ee as default};
