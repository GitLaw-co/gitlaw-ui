import{j as t}from"./jsx-runtime-DiklIkkE.js";const l={primary:{bg:"bg-primary",text:"text-text-negative"},secondary:{bg:"bg-secondary",text:"text-text-button"},red:{bg:"bg-destructive",text:"text-text-negative"},orange:{bg:"bg-alert",text:"text-text-negative"},green:{bg:"bg-positive",text:"text-text-negative"}},i=({type:s="red",showNumber:n=!0,count:a=7,className:r=""})=>{const e=l[s];return n?t.jsx("div",{className:`
