import{j as e}from"./jsx-runtime-DiklIkkE.js";import{r as p}from"./index-DRjF_FHU.js";import{I as m,c as n}from"./Icon-D7PltpT4.js";import{B as D}from"./Button-7IY71hMF.js";const L="size-5",l=({type:i="file",title:o,description:y,ownerName:w,ownerInitials:d,ownerAvatar:b,visibility:f="private",organizationName:S,starred:z=!1,selected:I=!1,filesCount:T=0,files:R=[],onClick:h,onDoubleClick:x,onStarClick:v,onMenuClick:g,onFileClick:N,doubleClickThreshold:t=250,className:s=""})=>{const a=i==="folder",u=p.useRef(0),c=p.useRef(null),j=p.useCallback(()=>{const r=Date.now(),C=r-u.current;C<t&&C>0?(c.current&&(clearTimeout(c.current),c.current=null),u.current=0,x==null||x()):(u.current=r,c.current&&clearTimeout(c.current),c.current=setTimeout(()=>{h==null||h(),c.current=null},t))},[h,x,t]),W=()=>{switch(f){case"private":return"Private";case"public":return"Public";case"shared":return"Shared";case"organization":return S||"Organization";default:return"Private"}},_=()=>{switch(f){case"private":return e.jsx(m,{name:"lock",className:"size-6 shrink-0",color:n.iconSecondary});case"public":return e.jsx(m,{name:"earth",className:"size-6 shrink-0",color:n.iconSecondary});case"shared":return e.jsx(m,{name:"users-round",className:"size-6 shrink-0",color:n.iconSecondary});case"organization":return e.jsx(m,{name:"building-2",className:"size-6 shrink-0",color:n.iconSecondary});default:return e.jsx(m,{name:"lock",className:"size-6 shrink-0",color:n.iconSecondary})}},F=()=>e.jsxs("div",{className:"flex flex-col gap-4 w-full h-full",children:[e.jsxs("div",{className:"flex items-center justify-between w-full",children:[w&&e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsx("div",{className:"size-6 rounded bg-primary flex items-center justify-center shrink-0",children:b?e.jsx("img",{src:b,alt:w,className:"w-full h-full object-cover rounded"}):e.jsx("span",{className:"text-[10px] font-black text-negative",children:d})}),e.jsx("span",{className:"text-xs font-normal text-foreground leading-[1.4]",children:w})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{type:"button",onClick:r=>{r.stopPropagation(),v==null||v()},className:"p-1 hover:bg-secondary rounded transition-colors hidden @[200px]:block",children:e.jsx(m,{name:"star",className:L,color:z?n.iconPrimary:n.iconDisabled})}),e.jsx("button",{type:"button",onClick:r=>{r.stopPropagation(),g==null||g()},className:"p-1 hover:bg-secondary rounded transition-colors",children:e.jsx(m,{name:"ellipsis",className:L,color:n.iconSecondary})})]})]}),e.jsx("h3",{className:"font-serif text-2xl font-normal text-foreground leading-[1.4]",children:o}),y&&e.jsx("p",{className:"text-sm font-normal text-subtle leading-[1.4]",children:y})]}),B=()=>e.jsxs("div",{className:"flex flex-col gap-3 w-full h-full",children:[e.jsxs("div",{className:"flex items-center gap-2 p-3 w-full",children:[e.jsxs("div",{className:"flex items-center gap-2 flex-1 min-w-0",children:[e.jsx(m,{name:"folder-closed",className:"size-6 shrink-0",color:n.iconPrimary}),e.jsxs("div",{className:"flex flex-col flex-1 min-w-0",children:[e.jsx("h3",{className:"text-base font-normal text-foreground leading-[1.4] truncate",children:o}),e.jsxs("span",{className:"text-xs font-normal text-subtle leading-[1.4] hidden @[200px]:block",children:[T," files"]})]})]}),e.jsxs("div",{className:"flex items-center gap-2 shrink-0",children:[e.jsx("button",{type:"button",onClick:r=>{r.stopPropagation(),v==null||v()},className:"p-1 hover:bg-secondary rounded transition-colors hidden @[200px]:block",children:e.jsx(m,{name:"star",className:L,color:z?n.iconPrimary:n.iconDisabled})}),e.jsx("button",{type:"button",onClick:r=>{r.stopPropagation(),g==null||g()},className:"p-1 hover:bg-secondary rounded transition-colors",children:e.jsx(m,{name:"ellipsis",className:L,color:n.iconSecondary})})]})]}),e.jsx("div",{className:"w-full h-px bg-border"}),e.jsx("div",{className:"flex flex-col w-full flex-1 overflow-hidden",children:R.slice(0,6).map(r=>e.jsxs("div",{className:"flex items-center gap-2 min-h-12 p-3 hover:bg-secondary/50 transition-colors cursor-pointer",onClick:C=>{C.stopPropagation(),N==null||N(r)},children:[e.jsx(m,{name:"file-text",className:"size-6 shrink-0",color:n.iconDisabled}),e.jsx("span",{className:"text-base font-normal text-foreground truncate",children:r.name})]},r.id))})]});return e.jsxs("div",{className:`
